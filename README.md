...
|---|---|
| Power BI & restitution | [Projet 02](#projet-02) · [Projet 04](#projet-04) |
| SQL & bases de données | [Projet 09](#projet-09) · [Projet 08](#projet-08) |
| Python / R — analyse & modélisation | [Projet 07](#projet-07) · [Projet 01](#projet-01) |
| Excel avancé (TCD, formules, VBA) | [Projet 11](#projet-11) |
| Qualité des données & RGPD | [Projet 08](#projet-08) · [Projet 10](#projet-10) |
| ETL / Power Query | Expérience VMS |
| Étude de marché & analyse business | [Projet 03](#projet-03) |
...
- **LinkedIn** — comptes spécialisés Power BI / DAX / Power Query (ex. Nicolas Brabant)
